          ...
          <div class="hidden md:flex">
            <ul class="text-xl text-[#11477B] flex gap-5 items-center font-medium inter-medium">
              <li><a href="../hommme 2/home 2.html" class="hover:text-[#3498db] animate__animated animate__fadeInDown">Home</a></li>
                  <li><a href="../services/services.html" class="hover:text-[#3498db] animate__animated animate__fadeInDown underline underline-offset-4">Services</a></li>
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-28 mt-5 mx-4 md:mx-28 max-w-screen-2xl">
            ...
            <div class="w-full sm:w-[431px] h-[534px]">
                ...
                <div class="mt-7 flex justify-center">
                    <a href="../before interview/bef-inter.html" class="bg-white text-[#3498DB] px-[100px] py-0 rounded-full text-nowrap hover:bg-[#11477b] hover:text-white border border-[#3498DB] font-light inter-light text-[26px] transition duration-300">
                        Start Now
                    </a>
                </div>
            </div>
            ...
            <div class="w-full sm:w-[431px] h-[534px]">
                ...
                <!-- Button -->
                <div class="mt-7 flex justify-center">
                    <a href="../new/vc.html" class="bg-white text-[#3498DB] px-[100px] py-0 rounded-full text-nowrap hover:bg-[#11477b] hover:text-white border border-[#3498DB] font-light inter-light text-[26px] transition duration-300">
                        Start Now
                    </a>
                </div>
            </div>
    ...
    <script src="{{asset('js\services.js')}}"></script>
        ...
        function checkLogin() {
            ...
            if (isLoggedIn !== 'true') {
                ...
                // If logged in, allow the page to render
