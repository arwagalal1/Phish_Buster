      ...
      <div class="max-w-9xl mx-auto px-4">
        <div class="flex justify-between items-center py-1">
          ...
          <div class="hidden md:flex">
            <ul class="text-xl text-[#11477B] flex gap-5 items-center font-medium inter-medium">
              <li><a href="../hommme/home.html" class="hover:text-[#349BDB] underline underline-offset-4">Home</a></li>
        ...
        <div id="menu" class="hidden md:hidden">
          <ul class="text-xl text-[#11477B] flex flex-col gap-3 pb-4 font-medium inter-medium">
            <li><a href="../hommme/home.html" class="block hover:text-[#349BDB] underline underline-offset-4">Home</a></li>
         ...
         <div class= "bg-white flex md:mt-40 mt-20 justify-between mx-20 sm:flex-row flex-col gap-6">
            <div class="w-full md:w-[594px] md:flex-col m-12 sm:w-[450px] ">
                ...
                <div class="items-center mt-4">
                    <a href="../services/services.html" class="btn anim font-light inter-light text-[26px] outline bg-[#ffff] text-[#3498DB] px-28 py-1 rounded-full hover:bg-[#11477b] hover:text-white border w-auto cursor-pointer">
                        Services
                    </a>
                </div>
            </div>
